"""
分析: 网址https://q.10jqka.com.cn/
get请求,直接构造请求网址https://q.10jqka.com.cn/index/index/board/all/field/zdf/order/desc/page/{}/ajax/1/即可
观察请求头中cookie中参数v会发生变化,headers中hexin-V会变化
解决:
补环境解决参数v,尝试请求,可以获取数据,后端不验证hexin-V
"""
...
js_code = execjs.compile(open('demo_get_cookie_v.js', encoding='utf-8').read())
